...
- [ ] T109 [US1] Add a provenance statement to `docs/fork-platform-changes.md`. The file already carries one; this task is to confirm it after the automated checks exist, which T106 and T107 now provide
